...
public class MenuNavegacaoActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_custumer) {
            // Handle the custumer action
            Toast.makeText(this, "custumer", Toast.LENGTH_SHORT).show();
            Intent intentFormulario = new Intent(MenuNavegacaoActivity.this, MainActivity.class);
